...
from shift_board.cli import main
from shift_board.models import Note, ProjectState, Task
from shift_board.cli import demo_state
from shift_board.storage import load_state, save_state
from shift_board.models import generate_short_id
from shift_board.validation import normalize_tags, require_text, validate_task_status
from shift_board.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
